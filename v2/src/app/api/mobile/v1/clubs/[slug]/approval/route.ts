import { getClubBySlug, setClubRequiresApproval } from "@/db/queries/book-clubs";
...
export async function POST(request: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    await setClubRequiresApproval(club.id, requiresApproval, session.userId, session.userType);
